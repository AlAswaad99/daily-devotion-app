...
export function SummaryQuestions({
  ...
  return (
    <View style={styles.wrap}>
      <Text style={[styles.lede, { fontFamily: f.body, lineHeight: lineHeightFor(language, 16) }]}>
        {translate('summaryLede', language)}
      </Text>
      ...
      <View style={styles.progressRow}>
        ...
        <Text style={[styles.progressText, { fontFamily: f.label }]}>
...
const styles = StyleSheet.create({
  ...
  lede: { fontSize: 16, color: theme.color.inkBodySoft },
  ...
  chipPaint: { borderRadius: 9 },
  chipText: { fontSize: 13, color: theme.color.inkDeep },
  chipTextOff: { color: theme.color.inkFaint },
