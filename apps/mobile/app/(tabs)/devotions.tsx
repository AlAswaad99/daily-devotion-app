...
const styles = StyleSheet.create({
  ...
  chipText: { fontSize: theme.size.label, color: theme.color.ink },
  ...
  bookTitle: { fontSize: theme.size.title, fontWeight: '600', color: theme.color.ink },
  bookMeta: { fontSize: theme.size.label, color: theme.color.inkMuted },
  track: {
    height: 6,
    borderRadius: 3,
  ...
  dayTitle: { fontSize: theme.size.body, color: theme.color.ink },
  dayMeta: { fontSize: theme.size.micro, color: theme.color.inkMuted },
