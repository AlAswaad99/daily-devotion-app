...
const styles = StyleSheet.create({
  ...
  flame: { fontSize: 56 },
  count: { fontSize: 48, fontWeight: '800', color: theme.color.flame },
  countLabel: {
  ...
  repairTitle: { fontSize: theme.size.body, fontWeight: '700', color: theme.color.accent },
  repairBody: { fontSize: theme.size.label, color: theme.color.ink, lineHeight: 20 },
  repairButton: {
  ...
  repairCost: { color: theme.color.surface, fontSize: theme.size.micro, opacity: 0.9 },
  repairSecondary: { alignItems: 'center', paddingVertical: theme.space(0.5) },
  repairSecondaryText: { color: theme.color.accent, fontSize: theme.size.label },
  monthHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  },
  monthTitle: { fontSize: theme.size.body, fontWeight: '700', color: theme.color.ink },
  monthNav: { fontSize: 28, color: theme.color.inkMuted, paddingHorizontal: theme.space(2) },
  ...
  cellText: { fontSize: theme.size.label, color: theme.color.ink },
  ...
  legendLabel: { fontSize: theme.size.label, color: theme.color.inkMuted },
})
