...
const styles = StyleSheet.create({
  ...
  name: { fontSize: theme.size.body, fontWeight: '600', color: theme.color.ink },
  ...
  help: { fontSize: theme.size.label, color: theme.color.inkMuted },
  row: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: theme.space(2),
  ...
  rowHelp: { fontSize: theme.size.micro, color: theme.color.inkMuted },
